...
Peter Attia
Last modified May 27, 2020 by Patrick Asinger
...
def sim(C1, C2, C3, dSOC1=0.2, dSOC2=0.2, dSOC3=0.2, mode='hi', sigma=164, seed=0, max_SOC=0.8, max_time=1./6.,
    ...
    t1 = dSOC1 / C1 * 3600 # [=] s, time of C1
    t2 = dSOC2 / C2 * 3600 # [=] s, time of C2
    t3 = dSOC3 / C3 * 3600 # [=] s, time of C3
    t4 = (max_time - t3/3600 - t2/3600 - t1/3600) * 3600 # [=] s, time of C4
    C4 = (max_SOC - dSOC3 - dSOC2 - dSOC1) / t4 # [=] 1/hr, rate of C4
    ...
    dt = 2    # [=] s, time step. <2s for minimal error, 5s is reasonable
